                                ...
                                <div class="col-xlg-10 col-lg-9 col-md-9">
                                    <div class="card-block">
                                        <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                                            ...
                                            <button type="submit" value="deletesent" name="deletesent" class="btn btn-secondary font-18 text-dark"><i class="mdi mdi-delete"></i></button>
                                        </div>
                                        <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                                                ...
                                                <table class="table table-hover no-wrap">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="unread">
                                                            ...
                                                            <td class="hidden-xs-down"><?php echo $rid ;?></td>
                                                            <td class="max-texts"> <a href="<?php echo 'email-detail.php?consent=  '.rawurlencode($mid).'%%^%))@^()' ; ?> "/><span class="label label-info m-r-10">Work</span> <?php echo $s ;?></td>
