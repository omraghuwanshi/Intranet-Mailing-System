                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <form method="post" action="delete_msg.php" >
                                            <button type="submit" name="delete" value="delete" class="btn btn-secondary font-18 text-dark"><i class="mdi mdi-delete"></i></button>
                                        </div>
                                        <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
...
{ 
                                                        ...
                                                        <tr class="unread">
                                                            ...
                                                            <td class="max-texts"> <a href="<?php echo 'email-detail.php?coninb=   '.rawurlencode($mid).'%%^%##()' ; ?>   "/><span class="label label-info m-r-10">Work</span> <?php  echo $s ;?></td>
