                    ...
                    <div class="col-lg-12">
                        <div class="card">
                           ...
                           <!--  --> <form id="myform" method="post"  >     
                                        ...
                                        <button type="button " class="btn btn-secondary m-r-10 m-b-10 text-dark"><a href="draft_test.php"<i class="mdi mdi-reload font-18"></i></a></button>
                                        <div class="btn-group" role="group">
                                    ...
                                    <table id="myTable" class="table table-hover">
                                        ...
                                        if ($no2>0) 
                                           {  
                                            ...
                                            <tr>
                                                <td><?php echo $u_id ;?></td>
                                                <td ><a href="<?php echo 'email-detail.php?condraft='.$draftId ; ?> "/><span class="label label-info m-r-10">Work</span> <?php echo $sub ;?></td>
                                                <td ><?php echo $date; ?></td>
                                                <td >
                                                    <button  name="delete" class="btn btn-secondary font-18 text-dark"><a href="<?php echo 'delete_msg_test.php?drafdel='.$draftId ; ?> "><i class="mdi mdi-delete"></i></a></button>
                                                </td>
                                            </tr>
