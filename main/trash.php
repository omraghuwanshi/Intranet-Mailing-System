...
$sqlr="SELECT * FROM usermail where rec_id='$id'";
$resulti=mysqli_query($con,$sqlr);
...
$sqlt="SELECT * FROM trash where rec_id='$id'";
$ddt=mysqli_query($con,$sqlt);
$no3=mysqli_num_rows($ddt);
                                ...
                                <div class="col-xlg-2 col-lg-3 col-md-3">
                                    <div class="card-block inbox-panel"><a href="compose.php" class="btn btn-danger m-b-20 p-10 btn-block waves-effect waves-light">Compose</a>
                                        <ul class="list-group list-group-full">
                                            <li class="list-group-item "> <a href="inbox.php"><i class="mdi mdi-gmail"></i> Inbox </a><span class="badge badge-success ml-auto"><?php echo $no ;?></span></li>
                                            ...
                                            <li class="list-group-item active">
                                                <a href="trash.php"> <i class="mdi mdi-delete"></i> Trash </a><span class="badge badge-danger ml-auto"><?php echo $no3 ;?></span>
                                            </li>
                                        </ul>
                                ...
                                <div class="col-xlg-10 col-lg-9 col-md-9">
                                    <div class="card-block">
                                        <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                                            ...
                                            <button type="submit" value="deletetrash" name="deletetrash" class="btn btn-secondary font-18 text-dark"><i class="mdi mdi-delete"></i></button>
                                        </div>
                                        <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                                                ...
                                                <table class="table table-hover no-wrap">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if($no3>0){
                                                           ...
                                                           while(list($mid,$rid,$sid,$s,$m,$a,$d)=mysqli_fetch_array($ddt)) 
                                                            {?>
                                                        ...
                                                        <tr class="unread">
                                                            ...
                                                            <td style="width:40px">
                                                                <div class="checkbox">
                                                                    <input type="checkbox" id="<?php echo $mid; ?>" name="ch[]" value="<?php  echo $mid ;?>" >
                                                                    <label for="<?php echo $mid; ?>" ></label>
                                                                </div>
                                                            </td>
                                                            <td style="width:40px" class="hidden-xs-down"><i class="fa fa-star-o"></i></td>
                                                            <td class="hidden-xs-down"><?php echo $sid ;?></td>
                                                            <td class="max-texts"> <a href="<?php echo 'email-detail.php?contrash=  '.rawurlencode($mid).'%%^%!!^^()' ; ?> "/><span class="label label-info m-r-10">Work</span> <?php echo $s ;?></td>
