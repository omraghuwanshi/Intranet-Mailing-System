                                    ...
                                    <table id="myTable" class="table table-hover">
                                        ...
                                        if ($no2>0) 
                                           {  
                                            ...
                                            <tr>
                                                <td><?php echo $u_id ;?></td>
                                                <td ><a href="<?php echo 'email-detail.php?condraft=  '.rawurlencode($draftId).'%%^%%%*)(()' ; ?> "/><span class="label label-info m-r-10">Work</span> <?php echo $sub ;?></td>
                                                <td ><?php echo $date; ?></td>
                                                <td >
                                                    <button  name="delete" class="btn btn-secondary font-18 text-dark"><a href="<?php echo 'delete_msg_copy.php?draftdel='.$draftId ; ?> "><i class="mdi mdi-delete"></i></a></button>
                                                </td>
                                            </tr>
