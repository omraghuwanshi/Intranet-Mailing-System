                                        ...
                                        <?php 
                                          ...
                                          if($no1>0){
                                           while(list($mid,$rid,$sid,$s,$m,$a,$d)=mysqli_fetch_array($dd))
                                            ...
                                            <tr>
                                                <td><?php echo $rid ;?></td>
                                                <td ><a href="<?php echo 'email-detail.php?consent=  '.rawurlencode($mid).'%%^%))@^()' ; ?> "/><span class="label label-info m-r-10">Work</span> <?php echo $s ;?></td>
                                                <td ><?php echo $d; ?></td>
                                                <td >
                                                    <button  name="delete" class="btn btn-secondary font-18 text-dark"><a href="<?php echo 'delete_msg_copy.php?sentdel='.$mid ; ?> "><i class="mdi mdi-delete"></i></a></button>
                                                </td>
                                            </tr>
