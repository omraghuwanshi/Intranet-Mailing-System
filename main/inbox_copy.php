                                    ...
                                    <table id="myTable" class="table table-hover">
                                        ...
                                        <?php 
                                           ...
                                           if (mysqli_num_rows($result)>0) 
                                            ...
                                            <tr>
                                                <td><?php echo $sid ;?></td>
                                                <td ><a href="<?php echo 'email-detail.php?coninb=   '.rawurlencode($mid).'%%^%##()' ; ?>   "/><span class="label label-info m-r-10">Work</span> <?php  echo $s ;?></td>
                                                <td ><?php echo $d; ?></td>
                                                <td >
                                                    <button  name="delete" class="btn btn-secondary font-18 text-dark"><a href="<?php echo 'delete_msg_copy.php?inbdel='.$mid ; ?> "><i class="mdi mdi-delete"></i></a></button>
                                                </td>
                                            </tr>
