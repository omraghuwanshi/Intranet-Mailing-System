                                        ...
                                        //while($row = mysqli_fetch_assoc($result))
                                         if($no3>0){
                                          while(list($mid,$rid,$sid,$s,$m,$a,$d)=mysqli_fetch_array($ddt)) 
                                            ...
                                            <tr>
                                                <td><?php echo $sid ;?></td>
                                                <td ><a href="<?php echo 'email-detail.php?contrash=  '.rawurlencode($mid).'%%^%!!^^()' ; ?> "/><span class="label label-info m-r-10">Work</span> <?php echo $s ;?></td>
                                                <td ><?php echo $d; ?></td>
                                                <td >
                                                    <button  name="delete" class="btn btn-secondary font-18 text-dark"><a href="<?php echo 'delete_msg_copy.php?trashdel='.$mid ; ?> "><i class="mdi mdi-delete"></i></a></button>
                                                </td>
                                            </tr>
