                                ...
                                <div class="col-xlg-10 col-lg-9 col-md-9">
                                    <div class="card-block">
                                        <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                                            ...
                                            <button type="submit" value="deletedraft" name="deletedraft"class="btn btn-secondary font-18 text-dark"><i class="mdi mdi-delete"></i></button>
                                        </div>
                                        <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                                                ...
                                                <table class="table table-hover no-wrap">
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                         ...
                                                         if ($no2>0) 
                                                        {  
                                                        while(list($draftId,$u_id,$sub,$file,$msg,$date)=mysqli_fetch_array($ddd))
                                                        ...
                                                        <tr class="unread">
                                                            ...
                                                            <td style="width:40px">
                                                                <div class="checkbox">
                                                                    <input type="checkbox" id="<?php echo $draftId; ?>" name="ch[]" value="<?php echo $draftId ;?>" >
                                                                    <label for="<?php echo $draftId; ?>" ></label>
                                                                </div>
                                                            </td>
                                                            <td style="width:40px" class="hidden-xs-down"><i class="fa fa-star-o"></i></td>
                                                            <td class="hidden-xs-down"><?php echo $u_id ;?></td>
                                                            <td class="max-texts"> <a href="<?php echo 'email-detail.php?condraft=  '.rawurlencode($draftId).'%%^%%%*)(()' ; ?> "/><span class="label label-info m-r-10">Work</span> <?php echo $sub ;?></td>
